...
* little-things：主题性的想法
    * [微信客服这件事](https://github.com/whatis-geb/operation/blob/master/little-things/customer-service.md)
    * [关于参展](https://github.com/whatis-geb/operation/blob/master/little-things/waic2023.md)
    * [内容运营细分之内容加工](https://github.com/whatis-geb/operation/blob/master/little-things/make-content.md)：“内容”是运营工作很重要的一块，这里提了点想法，但需要时间再单独写篇；
* little-tools：运营工具，可能有些已经过时了
    * 数据脚本：由 GPT-3.5 和 GPT-4 编写的爬虫小工具：可爬取 discourse 论坛浏览数据 [https://github.com/whatis-geb/operation/blob/master/little-tools/scrolling-table-page.py](https://github.com/whatis-geb/operation/blob/master/little-tools/scrolling-table-page.py)、可爬取墨天轮平台阅读数（精确到个位数） [https://github.com/whatis-geb/operation/blob/master/little-tools/crawler-modb.py](https://github.com/whatis-geb/operation/blob/master/little-tools/crawler-modb.py)
* little-toys：迭代，我觉得是最重要的运营技能。所以，得好好学习。这里放一些不保证时效性的学习资料；
* little-money：面试相关——最近我在找工作，我对感兴趣的 JD 会写一份文稿——这里收录了我所有感兴趣、面过公司的文稿记录，分为面试体感、准备面试资料、面试题（如果我记得的话）。蚂蚁数据智能、字节 Trae、阿里达摩院我都没准备文稿，不出意外的一面挂了，所以这里不放了。
    * [SpatialLM](https://github.com/whatis-geb/operation/blob/master/little-money/SpatialLM.md)：唯一写了应聘文稿，HR 没搭理我的。我很喜欢这个产品…可惜
    * [Dify](https://github.com/whatis-geb/operation/blob/master/little-money/SpatialLM.md)：应聘之前写了的文稿，后面加了面试之后的复盘内容；
    * 阶跃星辰：唯一一个 offer
